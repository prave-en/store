...
<table align="center" border="0" width="100%" bgcolor="#a3a2a2">
  ...
  <tr><td height="10px" align="center"><b><u>Take Order</u></b></td></tr>
...
<form method="POST" action="order1.php" autocomplete="off">
  <table class="table tab table-bordered" id="crud_table" border="1" width="97%">
    <tr><td colspan="5"><input list="select1" type="text" name="customers_detail[]" placeholder="Customers Details" autofocus="" style="width: 20%" required=""></td></tr>
    <tr align="center">
      <th>S no.</th>
    ...
    <tr><td align="right"><input type="submit" name="done" value="Done" class="tab entrybtn">&nbsp&nbsp</td></tr>
